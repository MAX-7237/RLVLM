...
def get_vision_backbone_and_transform(
    ...
    rl_target_layers: Optional[Tuple[int, ...]] = None,
    rl_threshold: Optional[float] = None,
    rl_min_keep_ratio: Optional[float] = None,
    ...
    if vision_backbone_id in VISION_BACKBONES:
        ...
        if issubclass(vision_cfg["cls"], TimmViTBackbone):
            instantiation_kwargs["rl_pruning"] = rl_pruning
            if rl_target_layers is not None:
                instantiation_kwargs["rl_target_layers"] = tuple(rl_target_layers)
            if rl_threshold is not None:
                instantiation_kwargs["rl_threshold"] = rl_threshold
            if rl_min_keep_ratio is not None:
                instantiation_kwargs["rl_min_keep_ratio"] = rl_min_keep_ratio
            if rl_policy_path is not None:
                instantiation_kwargs["rl_policy_path"] = rl_policy_path

        vision_backbone: VisionBackbone = vision_cfg["cls"](**instantiation_kwargs)
